...
<form action="postmailpro.php" method="post" enctype="multipart/form-data">
    ...
    <div class="flexform">
        ...
        <div class="mb-3">
            <input class="form-control" id="phone_number" name="phone_number" placeholder="多通手機以逗號分隔 ex:0975841257,0956874951" style="max-width: 500px;" type="text" value="" readonly="readonly">
        </div> -->
        ...
        <div class="mb-1">
            <label for="file">上傳發送名單:</label>
        </div>

        <div class="input-group mb-3">
            <input class="form-control" id="file" name="file" style="max-width: 400px;" type="file" accept=".csv">
        </div>

        <div class="mb-2">
            <label class="redText">請注意上傳副檔名是否為 .csv</label>
        </div>
